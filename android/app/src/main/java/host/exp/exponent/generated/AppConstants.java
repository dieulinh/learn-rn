...
public class AppConstants {
  ...
  public static String INITIAL_URL = "exp://exp.host/@jerryc91/learn-rn";
  public static final boolean IS_DETACHED = true;
  public static final String SHELL_APP_SCHEME = "exp97a9c163d4b64dab8610a7d1d2c99dae";
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@jerryc91/learn-rn/index.exp", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40jerryc91%2Flearn-rn%2F1.0.0%2F72d3b9e1dba9be3a3d54982c40bedd11-29.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
